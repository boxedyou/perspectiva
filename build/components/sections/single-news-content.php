                    ...
                    <nav class="news-content__subject-menus">
                        <ul class="news-content__menus-list">
                          <?php foreach ($toc_items as $index => $item) : ?>
                              <li class="news-content__menu-item<?php echo $index === 0 ? ' active' : ''; ?>">
                                  <a class="news-content__menu-anchor" href="#<?php echo esc_attr($item['id']); ?>"><?php echo esc_html($item['text']); ?></a>
                              </li>
                          <?php endforeach; ?>
                        </ul>
                    </nav>
