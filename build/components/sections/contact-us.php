                ...
                <div class="contact-us__inner">
                    <div class="contact-us__item">
                        ...
                        <div class="contact-us__info-inner">
                            ...
                            <p class="contact-us__info">Пн-Пт: 9:00 — 18:00</p>
                            <p class="contact-us__info">Сб-Вс: выходные</p>
                        </div>
                        <div class="contact-us__info-inner">
                            <p class="contact-us__text">Телефон</p>
                            <a class="contact-us__info" href="tel:+74951289732">+7 (495) 128-97-32</a>
                        </div>
                        <div class="contact-us__info-inner">
                            <p class="contact-us__text">Email</p>
                            <a class="contact-us__info" href="mailto:sales@fasad-material.ru">sales@fasad-material.ru</a>
                        </div>
                    </div>
                    <div class="contact-us__item">
                        ...
                        <div class="contact-us__info-inner">
                            <p class="contact-us__text">Предложения по перевозке грузов, сертификации, продаже расходных материалов отправляйте на почту:</p>
                            <a class="contact-us__info" href="mailto:logistics@fasad-material.ru">logistics@fasad-material.ru</a>
                        </div>
                    </div>
                    <div class="contact-us__item">
                        ...
                        <div class="contact-us__info-inner">
                            ...
                            <a class="contact-us__info" href="mailto:marketing@fasad-material.ru">marketing@fasad-material.ru</a>
                        </div>
                    </div>
                </div>
              <?php include __DIR__ . '/../elements/form.php'; ?>
