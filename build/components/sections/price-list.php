<section class="price-list">
  <div class="container">
    ...
    <table>
      ...
      <tbody>
      <tr>
        <td colspan="2">ГЛАДКООКРАШЕННАЯ</td>
      </tr>
      <tr>
        <td>Фасадная плита «Фасад Колор» гладкоокрашенная размер 1200*1570*8 мм (основа хризотил)</td>
        <td>1 110,00</td>
      </tr>
      <tr>
          <td>Фасадная плита «Фасад Колор» гладкоокрашенная размер 1200*1570*8 мм (основа хризотил)</td>
      ...
      <tr>
          <td colspan="2"><b>* Цены на фиброцементные панели не являются окончательными и могут быть изменены в зависимости от объема заказа, региона поставки и в результате личных переговоров сторон.</b></td>
      </tr>
      </tbody>
