<section class="single-category-hero">
    <div class="container">
        ...
        <div class="single-category-hero__wrapper">
            ...
            <div class="single-category-hero__item">
                <h3 class="single-category-hero__item-title">Фиброцементная панель RAL 3020</h3>
                ...
                <ul class="single-category-hero__list">
                    <li class="single-category-hero__list-item active"></li>
                    <li class="single-category-hero__list-item"></li>
                    <li class="single-category-hero__list-item"></li>
                    <li class="single-category-hero__list-item"></li>
                    <li class="single-category-hero__list-item"></li>
                    <li class="single-category-hero__list-item"></li>
                ...
                <div class="single-category-hero__size-inner">
                    <p class="single-category-hero__size">1200*3000*8 мм</p>
                    <p class="single-category-hero__size">1200*3000*8 мм</p>
                    <p class="single-category-hero__size active">1200*3000*8 мм</p>
                    <p class="single-category-hero__size">1200*3000*8 мм</p>
                    <p class="single-category-hero__size">1200*3000*8 мм</p>
                    <p class="single-category-hero__size">1200*3000*8 мм</p>
                    <p class="single-category-hero__size">1200*3000*8 мм</p>
                ...
                <div class="single-category-hero__price-wrapper">
                    ...
                    <button class="single-category-hero__button">Запросить цены</button>
                </div>
