<section class="single-category-hero">
    <div class="container">
        <h1 class="single-category-hero__title">Фиброцементные панели «ФАСАД-КОЛОР»</h1>
        <div class="single-category-hero__wrapper">
            ...
            <div class="single-category-hero__item">
                <h3 class="single-category-hero__item-title" data-item-name>Фиброцементная панель <span data-ral-name></span></h3>
               ...
               <div class="single-category-hero__color-inner">
                ...
                <ul class="single-category-hero__size-inner" data-size-parent>
                    <li class="single-category-hero__size active" data-size>1200*3000*8 мм</li>
                    <li class="single-category-hero__size" data-size>1200*300*8 мм</li>
                    <li class="single-category-hero__size" data-size>120*3000*8 мм</li>
                    <li class="single-category-hero__size" data-size>10*300*8 мм</li>
                    <li class="single-category-hero__size" data-size>1200*3000*8 мм</li>
                    <li class="single-category-hero__size" data-size>1200*3000*8 мм</li>
                    <li class="single-category-hero__size" data-size>1200*3000*8 мм</li>
                </ul>
                <div class="single-category-hero__price-wrapper">
                    <div class="single-category-hero__price-inner">
                        <p class="single-category-hero__price">от 1500 руб/м<sup>2</sup></p>
                ...
                <p class="single-category-hero__text-second">Производственная компания ТСК «Перспектива» занимается изготовлением и реализацией гладких окрашенных фасадных панелей из фиброцемента серии «Фасад-Колор» в Москве.</p>
                <a class="single-category-hero__link" href="#">Читать подробнее
