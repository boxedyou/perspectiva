<header class="header">
    <div class="header__wrapper">
        <a class="header__logo-inner" href="#">
            <img class="header__logo" src="./assets/images/logo/logo.svg" alt="Логотип" width="168" height="120" loading="lazy">
        </a>
        <div class="header__inner">
            <div class="header__item">
                <a class="header__logo-mobile-inner" href="#">
                    <img class="header__logo-mobile" src="./assets/images/logo/logo-mobile.svg" alt="Логотип" width="172" height="40" loading="lazy">
                </a>
                <nav class="header__nav">
                    <ul class="header__nav-list">
                        ...
                        <li class="header__list-item has-children">О компании
                            <svg width="11" height="6" viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.5 0.5L5.5 5.5L10.5 0.5" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <ul class="header__sub-list">
                ...
                <div class="header__text-inner">
                    ...
                    <button class="header__button-icon" type="button" data-mobile-popup>
            ...
            <div class="header__item">
                ...
                <div class="header__button-wrapper">
                    ...
                    <button class="header__button" type="button">Заказать расчёт фасада
