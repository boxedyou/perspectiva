<a class="category-item"  href="<?php echo esc_url( get_permalink( 23 ) ); ?>" data-filter-target="Вентфасады">
    ...
    <div class="category-item__size-wrapper">
        ...
        <p class="category-item__size">1200*3000*8 мм</p>
        <p class="category-item__size">1200*3000*8 мм</p>
        <p class="category-item__size">Спецразмер</p>
    </div>
    <p class="category-item__price">от 1500руб/м<sup>2</sup></p>
    <button class="category-item__button" type="button">Смотреть подробнее</button>
</a>
